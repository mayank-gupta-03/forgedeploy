...
This is the core backend service for ForgeDeploy, a Vercel-like deployment platform. It handles user authentication,
project management, and orchestrates the deployment lifecycle.
...
- **Entities:** Uses JPA with UUID primary keys for all major entities (`UserInfo`, `Project`, `Deployment`,
  `DeploymentJob`).
